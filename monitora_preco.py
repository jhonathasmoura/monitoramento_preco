...
if __name__ == '__main__':
    ...
    while True:
        urls = ['http://beans.itcarlow.ie/prices.html', 'http://beans.itcarlow.ie/prices-loyalty.html']
        ...
        if preco_normal < 4.70 or preco_promocional < 4.70:
            if min(preco_normal, preco_promocional) == preco_normal:
                ...
                envia_email(email_remetente, senha, email_destinatario, assunto, mensagem)
                break
